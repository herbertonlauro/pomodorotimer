...
// Define o volume padrão (entre 0 e 1)
var volumePadrao = 0.5;

// Define o volume para cada áudio
bell.volume = volumePadrao;
volta.volume = volumePadrao;
final.volume = volumePadrao;
...
// Acessa o controle de volume
let volumeControl = document.getElementById('volume');

// Atualiza o volume do áudio quando o controle de volume é alterado
volumeControl.addEventListener('input', function() {
    lofi.volume = volumeControl.value;
    lofi.volume = volumePadrao;
});
...
function momentoPausa() {
   ...
   document.body.classList.add("pausa");
    // Adiciona a classe "pausa" ao body
         ...
         if (min_pausa <= 0) {
            ...
            if (ses <= 0) {
               ...
               document.getElementById('fim').style.setProperty('display', 'block', 'important')
                final.addEventListener('ended', function() {
                  // Quando o áudio final terminar, recarregue a página
